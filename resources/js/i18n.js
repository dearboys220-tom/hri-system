...
export const i18n = createI18n({
    ...
    fallbackLocale: 'id',
    messages: {
        id: { ...id_common, ...id_welcome, ...id_company, ...id_jobs, ...id_about },
        ja: { ...ja_common, ...ja_welcome, ...ja_company, ...ja_jobs, ...ja_about },
        ko: { ...ko_common, ...ko_welcome, ...ko_company, ...ko_jobs, ...ko_about },
        en: { ...en_common, ...en_welcome, ...en_company, ...en_jobs, ...en_about },
    },
})
