        ...
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <!-- 書類URL（オプション） -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">URL Dokumen Pendukung <span class="text-gray-400">(opsional)</span></label>
                        <input type="url" v-model="form.document_url"
                               placeholder="https://drive.google.com/..."
                               class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
                        <p class="text-xs text-gray-400 mt-1">Surat sakit, surat keterangan, dll. (link Google Drive, dsb.)</p>
                    </div>
                    ...
                    <div v-for="r in myRequests" :key="r.id"
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-800">
                                {{ absenceTypeLabel(r.absence_type) }}
                            </p>
