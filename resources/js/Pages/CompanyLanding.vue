...
const features = [
    {
        icon: '🔍',
        title: 'Investigasi Latar Belakang Kandidat',
        desc: 'Verifikasi pendidikan, pengalaman kerja, dan sertifikasi secara independen oleh tim profesional HRI.',
    },
    {
        icon: '⭐',
        title: 'HRI Score Sekilas Pandang',
        desc: 'Visualisasi tingkat kepercayaan pelamar dalam skala 100 poin. Prioritas wawancara jadi lebih mudah.',
    },
    {
        icon: '🏆',
        title: 'Kandidat dengan Sertifikat Verifikasi',
        desc: 'Kandidat ber-HRI Verified Resume menjanjikan tingkat kepercayaan tinggi sejak awal proses rekrutmen.',
    },
    {
        icon: '📋',
        title: 'Posting Lowongan Terintegrasi',
        desc: 'Pasang lowongan langsung di platform HRI dan kelola seluruh lamaran dalam satu dashboard.',
    },
    {
        icon: '⚡',
        title: 'Percepat Proses Screening',
        desc: 'Hemat waktu hingga 80%. Fokus pada wawancara kandidat berkualitas, bukan verifikasi dokumen.',
    },
    {
        icon: '🔒',
        title: 'Data Aman & Sesuai UU PDP',
        desc: 'Seluruh data kandidat dikelola sesuai Undang-Undang Perlindungan Data Pribadi Indonesia.',
    },
]
...
const steps = [
    { num: '01', title: 'Registrasi Perusahaan', desc: 'Daftar akun perusahaan dengan email & password. Proses cepat.' },
...
<template>
    ...
    <section class="relative min-h-screen flex items-center overflow-hidden"
        ...
        <div class="relative max-w-6xl mx-auto px-4 py-32 text-center">
            <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur border border-white/20
                ...
                Platform Rekrutmen dengan Verifikasi CV Pihak Ketiga
            </div>

            <h1 class="text-4xl md:text-6xl font-black text-white leading-tight mb-6">
                CV yang Telah Diverifikasi<br>
                <span class="text-orange-300">guna Mendukung</span><br>
                Perekrutan Berkualitas
            </h1>

            <p class="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-10 leading-relaxed">
                HRI adalah sistem verifikasi CV oleh pihak ketiga yang membantu mengatasi
                tantangan rekrutmen di Indonesia. Temukan kandidat terpercaya dengan data yang akurat.
            </p>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-14">
                <span class="text-blue-600 font-semibold text-sm uppercase tracking-widest">Fitur Unggulan</span>
                <h2 class="text-3xl md:text-4xl font-black text-gray-900 mt-2">
                    Fitur HRI untuk Perusahaan
                </h2>
                <p class="text-gray-500 mt-4 max-w-2xl mx-auto">
                    Tingkatkan kualitas rekrutmen dengan sistem verifikasi kandidat yang komprehensif
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-black text-gray-900 mt-2 mb-6">
                        Item yang Diinvestigasi<br>Tim HRI
                    </h2>
                    <p class="text-gray-600 leading-relaxed mb-8">
                        Tim HRI melakukan investigasi mendalam terhadap seluruh informasi kandidat
                        melalui 3 tahap: Tim Investigasi, Tim Penilai, dan Tim Administrasi.
                        Hasilnya dapat dipertanggungjawabkan secara faktual.
                    </p>
                    <Link href="/register/company"
                          class="inline-block bg-blue-600 hover:bg-blue-700 text-white
                                 font-bold px-8 py-3 rounded-full transition">
                        Mulai Verifikasi Kandidat →
                    </Link>
                </div>
    ...
    <section class="py-20" style="background-color: #0f172a;">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-14">
                <span class="text-orange-300 font-semibold text-sm uppercase tracking-widest">Cara Kerja</span>
    ...
    <section class="py-24" style="background: linear-gradient(to right, #1e293b, #1e3a8a);">
        <div class="max-w-3xl mx-auto px-4 text-center">
            <h2 class="text-3xl md:text-4xl font-black text-white mb-6">
                Siap Merekrut Kandidat<br>yang Sudah Terverifikasi?
            </h2>
            <p class="text-blue-100 mb-10 leading-relaxed">
                Registrasi perusahaan gratis sekarang dan mulai posting lowongan.
                Temukan kandidat terbaik dengan CV yang sudah diinvestigasi secara profesional.
            </p>
                ...
                <div class="flex gap-12">
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <Link href="/register/company"  class="block hover:text-white transition">Daftar Perusahaan</Link>
